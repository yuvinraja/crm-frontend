...
import { MessageSquare, Calendar, Users, CheckCircle, XCircle, Eye } from "lucide-react"
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>All your campaigns sorted by most recent first</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <Table>
            ...
            <TableBody>
              {campaigns.map((campaign) => {
                const successRate =
                  campaign.audienceSize > 0 ? ((campaign.sent / campaign.audienceSize) * 100).toFixed(1) : "0"
                ...
                return (
                  <TableRow key={campaign._id} className="cursor-pointer hover:bg-muted/50">
                    <TableCell>
                      <div>
                        ...
                        {campaign.segmentName && (
                          <div className="text-sm text-muted-foreground">Target: {campaign.segmentName}</div>
                        )}
                      </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Badge
                        variant={campaign.failed === 0 ? "default" : "secondary"}
                        className={campaign.failed === 0 ? "bg-green-100 text-green-800" : ""}
                      >
                        {successRate}% success
                      </Badge>
                    </TableCell>
