...
import { Users, Target, MessageSquare, ShoppingCart, BarChart3, Menu, X, Sparkles, LogOut } from "lucide-react"
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center px-6 py-6 border-b border-sidebar-border">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-sidebar-foreground font-playfair">PulseFlow</h1>
            ...
            {user ? (
              ...
              <div className="flex items-center space-x-3 px-3 py-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-sidebar-foreground truncate">Not signed in</p>
